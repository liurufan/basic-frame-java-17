...
import org.basic.frame.domain.common.Constants;
import org.basic.frame.domain.service.UserService;
...
public class MyUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        org.basic.frame.infrastructure.entity.User userEntity = userService.findUserByEmail(username);
